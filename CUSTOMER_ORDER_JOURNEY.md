...
### STAGE 2: Order Delivered → Pending Confirmation ⚠️
```
┌─────────────────────────────────────────────────┐
│  Order #A1B2C3D4                    2024-04-24  │
├─────────────────────────────────────────────────┤
...
| 2. Delivered | 📦 Received | ● ──● ──── | ⚠️ | [CONFIRM] | ✓ OTP Sent |
| 3. Verifying | 📦 Received | ● ──● ──── | ⚠️ | Modal Open | - |
...
| 📦 Received ⚠️ | Delivered! Check email for OTP | **Click "Confirm Receipt" button** |
