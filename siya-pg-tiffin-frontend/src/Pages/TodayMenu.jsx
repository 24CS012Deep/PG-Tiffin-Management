            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {todaysMenuPlans.map((plan) => (
                  <div key={plan._id} className="bg-white rounded-3xl p-8 shadow-[0_10px_30px_rgba(249,115,22,0.1)] border-t-8 border-orange-500 hover:-translate-y-2 transition-transform duration-300 flex flex-col">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">{plan.name}</h3>
                    <p className="text-orange-600 font-bold text-lg mb-6">₹{plan.price}<span className="text-gray-400 text-sm font-normal">/month</span></p>
                    
                    <div className="bg-orange-50 rounded-2xl p-6 mb-6 border border-orange-100 flex-1">
                      <h4 className="font-bold text-gray-800 mb-4 flex items-center gap-2 text-lg border-b border-orange-200 pb-2">
                    ...
                    <Link to="/signin" className="block w-full text-center py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold rounded-xl hover:from-orange-600 hover:to-orange-700 transition-colors shadow-lg shadow-orange-200">
                      Login to Subscribe
                    </Link>
                  </div>
                ))}
              ...
              <div className="bg-white border border-gray-100 rounded-3xl p-16 text-center shadow-lg max-w-3xl mx-auto">
                ...
                <h3 className="text-3xl font-extrabold text-gray-900 mb-4">Kitchen is updating...</h3>
                <p className="text-gray-500 font-medium text-lg max-w-md mx-auto mb-8 leading-relaxed">
                  The chef is still planning today's delicious meals. Please check back shortly, or log in to view our monthly plans!
                </p>
